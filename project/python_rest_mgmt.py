...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="-Harman Dhindsa",bd=2,relief=SUNKEN)
...
txttotalcost=Entry(f1,font=('ariel', 15 ,'bold'),textvariable=Total,insertwidth=4,fg="light green", bg="light pink",bd=10,justify='right')
...
btnexit=Button(f1,padx=16,pady=8, bd=10 ,fg="black",font=('ariel' ,16,'bold'),width=10, text="EXIT", bg="light green",command=Exit)
